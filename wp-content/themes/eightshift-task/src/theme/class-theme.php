 ...
 *
 * @since   1.0.0
 * @package Eightshift_Task\Theme
 */

namespace Eightshift_Task\Theme;
...
class Theme implements Service {
  ...
  public function enqueue_styles() {
    ...
    // Main style file.
    \wp_register_style( ET_THEME_NAME . '-style', $this->manifest->get_assets_manifest_item( 'application.css' ), [], ET_THEME_VERSION );
