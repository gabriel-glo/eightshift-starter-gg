 ...
 *
 * @since   1.0.0
 * @package Eighshift_Task\Admin\Menu
 */

namespace Eighshift_Task\Admin\Menu;
...
class Menu implements Service {
  ...
  private function get_menu_positions() : array {
    return [
      'header_main_nav' => esc_html__( 'Main Menu', 'eighshift-task' ),
      'footer_main_nav' => esc_html__( 'Footer Menu', 'eighshift-task' ),
    ];
  }
